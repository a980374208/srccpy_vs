...
struct sc_demuxer_callbacks {
    void (*on_ended)(sc_demuxer* demuxer, enum sc_demuxer_status,
        void* userdata);
};
...
public:
    ...
    void init(const char* name,sc_socket socket, std::shared_ptr<sc_demuxer_callbacks> callbacks, void* cbs_userdata);
