...
bool
sc_process_observer_init(sc_process_observer& observer, sc_pid pid,
    const struct sc_process_listener& listener,
    void* listener_userdata);

void
sc_process_observer_join(sc_process_observer& observer);

void
sc_process_observer_destroy(sc_process_observer& observer);

bool
sc_process_observer_timedwait(sc_process_observer& observer,
    sc_tick deadline);


class process_observer_raii {
public:
    process_observer_raii(sc_pid pid,
        const sc_process_listener& listener,
        void* userdata)
    {
    ...
    bool timedwait(sc_tick deadline)
    {
        return sc_process_observer_timedwait(observer_, deadline);
    }
